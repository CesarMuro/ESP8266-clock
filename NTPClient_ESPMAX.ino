...
Modified by Cesar Muro on December 2017
I was added the control of the matrix displays
by the same way i was changed the NTP server for use Spanish one's
...
const char ssid[] = "******";     //  tu  SSID (nombre de la WIFI)
const char pass[] = "******";     //  la clave de tu WIFI
